...
public class UI extends JFrame
{
    ...
    // Frame settings
    private final String FRAME_TITLE = "Minesweeper ~ Developed by Moloy and Shanto";
    ...
    {                
        ...
        minesLabel.setFont(new Font("Serif", Font.BOLD, 18));
        minesLabel.setBorder(loweredetched);
        minesLabel.setBackground(new Color(255,255,255));
